...
CREATE TABLE IF NOT EXISTS `wonderfull_travel`.`pais` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_pais_continent1_idx` (`continent_id` ASC),
  CONSTRAINT `fk_pais_continent1` FOREIGN KEY (`continent_id`) REFERENCES `wonderfull_travel`.`continent` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `wonderfull_travel`.`ofertes` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `pais_id` FOREIGN KEY (`pais_id`) REFERENCES `wonderfull_travel`.`pais` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
-- -----------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `wonderfull_travel`.`reserva` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_reserva_oferta_idx` (`oferta_id` ASC),
  CONSTRAINT `fk_reserva_oferta` FOREIGN KEY (`oferta_id`) REFERENCES `wonderfull_travel`.`ofertes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE = InnoDB;
